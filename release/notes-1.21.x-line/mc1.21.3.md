...
本 jar 只适配 Minecraft 1.21.3,不要跨版本使用。
...
`OptiFabric-1.1.2+mc1.21.3.jar` — 780347 字节

`SHA-256: 81B1BA061411CC5CBE42994BB00186AA61900900805BCA6314E4BEEBD69929DE`