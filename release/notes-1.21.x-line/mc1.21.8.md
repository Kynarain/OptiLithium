...
本 jar 只适配 Minecraft 1.21.8,不要跨版本使用。
...
`OptiFabric-1.1.2+mc1.21.8.jar` — 828022 字节

`SHA-256: 9CDD9C6C0F387E8997F98809CF19BECAD22BB08C228621ED5517C20DF247C1BE`